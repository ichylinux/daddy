...
前提 /^rails g migration remove_column_last_name_on_users$/ do
  show 'db/migrate/20130513040300_remove_column_last_name_on_users.rb', :as => 'edit'
end

前提 /^rails g migration remove_column_first_name_on_users$/ do
  show 'db/migrate/20130513040307_remove_column_first_name_on_users.rb', :as => 'edit'
end

前提 /^rails g migration remove_column_gender_on_users$/ do
  show 'db/migrate/20130513040312_remove_column_gender_on_users.rb', :as => 'edit'
end

前提 /^rails g migration remove_column_birthday_on_users$/ do
